...
NYT_API_KEY = "Ot6euQfuU9UEzG4Yk9VngjkfkhnKKW1T"
AZURE_OPENAI_KEY = "6d9faf42dc8a4feaa81869f33d77f80d"
...
#
#     c.execute("""
#         DELETE FROM records WHERE id IN (2879,2859,2836,2676,2252,2235,2104)
#     """)
#
#     deleted_rows = c.rowcount
#     print(
#         f"Deleted {deleted_rows} rows where content='The content is related to \"nuclear\".'")
#
#     conn.commit()
#     conn.close()
